...
public class Level5 implements IScenario {
    ...
    public void initScenario() {
        ...
        structures.add(structureFactory.createStructure(new Point(192, 384)));
        ...
        structures.add(structureFactory.createStructure(new Point(640, 352)));
        structures.add(structureFactory.createStructure(new Point(640, 320)));
        structures.add(structureFactory.createStructure(new Point(640, 288)));
        ...
        structures.add(structureFactory.createStructure(new Point(352, 736)));
        structures.add(structureFactory.createStructure(new Point(255, 225)));
        ...
        structures.add(structureFactory.createStructure(new Point(385, 200)));
        ...
        structures.add(structureFactory.createStructure(new Point(608, 352)));
