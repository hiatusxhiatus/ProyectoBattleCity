...
public class Level7 implements IScenario {
    ...
    public void initScenario() {
        ...
        structures.add(structureFactory.createStructure(new Point(480, 600)));
        structures.add(structureFactory.createStructure(new Point(480, 570)));
        ...
        structures.add(structureFactory.createStructure(new Point(192, 416)));
        ...
        structures.add(structureFactory.createStructure(new Point(540, 384)));
        ...
        structures.add(structureFactory.createStructure(new Point(544, 415)));
        structures.add(structureFactory.createStructure(new Point(544, 380)));
        ...
        structures.add(structureFactory.createStructure(new Point(736, 96)));
        ...
        structures.add(structureFactory.createStructure(new Point(704, 96)));
