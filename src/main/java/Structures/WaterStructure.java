...
public class WaterStructure implements IStructure {
    ...
    public WaterStructure(Point location) {
        this.hp = Integer.MAX_VALUE;
        this.label = new JLabel();
        this.type = StructureType.Water;
    ...
    public void setUpLabel() {
        ...
        label.setIcon(ImageCache.loadImage("src/main/java/imagenes/waterBlock.png"));
